        ...
        <?php comment_form([
            ...
            'fields'            =>      [
                        'author'    =>      '<div class="col_one_third">
                                                <label>' .__('Name', 'generalized'). '</label>
                                                <input type="text" name="author" class="sm-form-control" /></div>',
                        'email'     =>      '<div class="col_one_third">
                                            <label>' .__('email', 'generalized'). '</label>
                                            <input type="text" name="email" class="sm-form-control" /> </div>',
                        'url'       =>      ' <div class="col_one_third col_last">
                                            <label>' .__('Website', 'generalized'). '</label>
                                            <input type="text" name="url" class="sm-form-control" />
                                        </div>'],
                        
            'class_submit'      =>      'button button-3d nomargin',
            'label_submit'      =>      __('Submit Comment', 'generalized'),
            'title_reply'       =>      __('Leave a <span>Comment</span>', 'generalized')
